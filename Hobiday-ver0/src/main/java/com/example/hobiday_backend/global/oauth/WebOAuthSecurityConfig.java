...
public class WebOAuthSecurityConfig {
    ...
    @Bean
    public WebSecurityCustomizer configure(){ // 스프링 시큐리티 기능 비활성화(백에드에서 리소스 사용할때만 코드 필요)
...
//                ->세션매니먼트 키고 /api/profile 요청은 받아서 로그인중인 사용자정보 잘 받아오는거 확인 (profile.js로 프론트에서 토큰 전송)
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/test/api/**")).permitAll() // 테스트용으로 인증없이 허용되는 URL
